...
\begin{document}
 ...
 softmax function.
  ...
  terms added together to aggregate the information from all samples.
   ...
   A learning rate of $1 \cdot 10^{-4}$ was used for $1000$ iterations, giving a training accuracy of $92.6\%$
   and a testing accuracy of $92.2\%$.
  ...
  \begin{figure}[H] \centering
      ...
      \caption{accuracy vs. number of iteration for learning rate of $10^-4$ \texttt{plot\_samples()}. }
   \end{figure}
